    ...
    <div className='container mx-auto px-4 my-6 relative'>
           ...
           {   loading ? (
            ...
            data.map((product,index)=>{
                return(
                    <Link to={"product/"+product?._id} className='w-full min-w-[330px] md:min-w-[360px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex' key={index} onClick={scrollTop}>
